...
\hline 
1.-El jugador inicia un turno de juego & 2.-La GUI le presenta al ususario un listado de palabras\\
\hline
...
\textbf{Acción de los actores} & \textbf{Respuesta del sistema}\\
\hline 
1.-El jugador abre la aplicación & 2.-La GUI le presenta al ususario un formulario de usuario y contraseña para ser rellenado\\
\hline
