...
\begin{figure}[htbp]
\centering
   \includegraphics[scale=0.9]{imgs/DiagramaCasoUso1.png}
   \begin{center}
   Diagrama del primer caso de uso
   \end{center}
\end{figure}

\begin{figure}[htbp]
\centering
   \includegraphics[scale=0.9]{imgs/DiagramaCasoUso2.png}
   \begin{center}
   Diagrama del segundo caso de uso
   \end{center}
\end{figure}

\begin{figure}[htbp]
\centering
   \includegraphics[scale=0.9]{imgs/DiagramaCasoUso3.png}
   \begin{center}
   Diagrama del tercer caso de uso
   \end{center}
\end{figure}

\begin{figure}[htbp]
\centering
   \includegraphics[scale=0.9]{imgs/DiagramaCasoUso4.png}
   \begin{center}
   Diagrama del cuarto caso de uso
   \end{center}
\end{figure}

\begin{figure}[htbp]
\centering
   \includegraphics[scale=0.9]{imgs/DiagramaCasoUso5.png}
   \begin{center}
   Diagrama del quinto caso de uso
   \end{center}
\end{figure}

\begin{figure}[htbp]
\centering
   \includegraphics[scale=0.9]{imgs/DiagramaCasoUso6.png}
   \begin{center}
   Diagrama del sexto caso de uso
   \end{center}
\end{figure}
