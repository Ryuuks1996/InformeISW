...
\begin{figure}[H]
 \centering
  \subfloat[prioridad]{\includegraphics[width=7cm, height=8cm]{imgs/planner_priority.png}}
  \subfloat[Gráfico de barra]{\includegraphics[width=7cm, height=8cm]{imgs/planner_bucket.png}}
